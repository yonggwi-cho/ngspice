...
#line 1 "parse-bison.y" /* yacc.c:339  */
...
#line 106 "parse-bison.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 48 "parse-bison.y" /* yacc.c:355  */

  double num;
  const char  *str;
  struct pnode *pnode;

#line 168 "parse-bison.c" /* yacc.c:355  */
};
...
#line 198 "parse-bison.c" /* yacc.c:358  */
...
static const char *const yytname[] =
{
  ...
  "TOK_NE", "'?'", "':'", "'|'", "'&'", "'='", "'<'", "'>'", "'~'", "','",
  "'-'", "'+'", "'*'", "'/'", "'%'", "NEG", "'^'", "'['", "']'", "'('",
  "')'", "$accept", "expression", "exp_list", "one_exp", "exp", YY_NULLPTR
};
#endif
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, char **line, struct pnode **retval)
{
...
#line 99 "parse-bison.y" /* yacc.c:1429  */
{
    (yylval).num = 0.0;
    yylloc.start = yylloc.stop = NULL;
}

#line 1263 "parse-bison.c" /* yacc.c:1429  */
  yyvsp[0] = yylval;
  yylsp[0] = yylloc;
  goto yysetstate;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 111 "parse-bison.y" /* yacc.c:1646  */
    { *retval = NULL; }
#line 1453 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 3:
#line 112 "parse-bison.y" /* yacc.c:1646  */
    { *retval = (yyvsp[0].pnode); }
#line 1459 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 5:
#line 117 "parse-bison.y" /* yacc.c:1646  */
    { (yyvsp[-1].pnode)->pn_next = (yyvsp[0].pnode); (yyvsp[0].pnode)->pn_use ++; (yyval.pnode) = (yyvsp[-1].pnode); }
#line 1465 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 6:
#line 121 "parse-bison.y" /* yacc.c:1646  */
    {
        (yyvsp[0].pnode)->pn_name = copy_substring((yylsp[0]).start, (yylsp[0]).stop);
        (yyval.pnode) = (yyvsp[0].pnode);
    }
#line 1474 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 7:
#line 128 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mknnode((yyvsp[0].num)); }
#line 1480 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 8:
#line 129 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mksnode((yyvsp[0].str)); txfree((yyvsp[0].str)); }
#line 1486 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 9:
#line 131 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_COMMA,  (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1492 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 10:
#line 132 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_PLUS,   (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1498 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 11:
#line 133 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_MINUS,  (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1504 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 12:
#line 134 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_TIMES,  (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1510 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 13:
#line 135 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_MOD,    (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1516 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 14:
#line 136 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_DIVIDE, (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1522 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 15:
#line 137 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_POWER,  (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1528 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 16:
#line 139 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = (yyvsp[-1].pnode); }
#line 1534 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 17:
#line 141 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkunode(PT_OP_UMINUS, (yyvsp[0].pnode)); }
#line 1540 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 18:
#line 142 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkunode(PT_OP_NOT, (yyvsp[0].pnode)); }
#line 1546 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 19:
#line 144 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkfnode((yyvsp[-3].str), (yyvsp[-1].pnode));
                                        txfree((yyvsp[-3].str));
                                        if(!(yyval.pnode))
                                            YYABORT;
                                      }
#line 1556 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 20:
#line 150 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_EQ, (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1562 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 21:
#line 151 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_NE, (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1568 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 22:
#line 152 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_GT, (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1574 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 23:
#line 153 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_LT, (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1580 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 24:
#line 154 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_GE, (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1586 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 25:
#line 155 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_LE, (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1592 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 26:
#line 157 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_AND, (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1598 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 27:
#line 158 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_OR,  (yyvsp[-2].pnode), (yyvsp[0].pnode)); }
#line 1604 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 28:
#line 160 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_INDX,  (yyvsp[-3].pnode), (yyvsp[-1].pnode)); }
#line 1610 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 29:
#line 161 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_RANGE, (yyvsp[-5].pnode), (yyvsp[-2].pnode)); }
#line 1616 "parse-bison.c" /* yacc.c:1646  */
    break;

  case 30:
#line 162 "parse-bison.y" /* yacc.c:1646  */
    { (yyval.pnode) = PP_mkbnode(PT_OP_TERNARY,(yyvsp[-4].pnode),
                                                     PP_mkbnode(PT_OP_COMMA,(yyvsp[-2].pnode),(yyvsp[0].pnode))); }
#line 1623 "parse-bison.c" /* yacc.c:1646  */
    break;


#line 1627 "parse-bison.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 166 "parse-bison.y" /* yacc.c:1906  */
